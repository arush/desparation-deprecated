...
class TBT_Rewardsinstore_Block_Manage_Earning_Cart_Edit extends Mage_Adminhtml_Block_Widget_Form_Container {
...
/*    				rule_discount_qty_row.show();
	...
	public function getHeaderText() {
		...
		if ($rule->getRuleId ()) {
			...
			return Mage::helper ( 'salesrule' )->__ ( 'New Instore Earning Rule' );
		}
	}
