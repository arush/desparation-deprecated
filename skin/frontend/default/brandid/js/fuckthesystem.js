...
/* 			console.log("del: %d / scroll2: %d = ratio: %d",window.meeting_rel, $j("#how").data("scrolls")[2], window.meeting_ratio);    */
	...
	$j(document).ready(function () {
	    ...
	    $j.reject({  
	        ...
	        closeMessage: 'By closing this you understand that your experience may be ruined courtesy of the lovely chaps at Microsoft.', // Message below close window link  
	        closeCookie: true
	    }); // Customized Text  
