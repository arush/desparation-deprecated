...
(function() {
  var MailChimpAPI, Parse, Recurly, app, auth, brandidApi, brandidAuth, express, intercom, intercom_settings, mcApiKey, mcList, mcapi, parse, parse_settings, port, recurly, xmlBodyParser,
